...
def load(paths, input_shape, verbose=-1):
    """Load images from directories and resize them to the specified input shape"""
    data = list()
    labels = list()
    # loop over the input images
    for i, imgpath in enumerate(paths):
        ...
        # normalize pixel values to [0, 1] and add to list
...
class PretrainedInceptionModel:
    @staticmethod
